...
// Because the .includes() string method already returns true if the word is included, and false if not, you can simply omit the if statement, and just return on the same line like this (keep in mind, you don't need the parentheses, this is just formatting from Prettier )
